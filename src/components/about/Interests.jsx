                ...
                <div className="d-flex">
                    <div className="mx-4 py-4 px-3 interestpara d-flex justify-content-center align-items-center">
                        <ol type="1">
                            ...
                            <li>&nbsp; video games. My favorite categories include</li>
                            <li>&nbsp; Racing,FPS,TPS,etc.Some notable mentions :</li>
                            <li>&nbsp; <b>GTA V,NFS Payback and God Of War,etc.</b></li>
                            <li>&nbsp; There's my youtube channel named as </li>
                            ...
                            <li>&nbsp;  In addition to this, I adore south Indian </li>
                            <li>&nbsp;  music for its lyrics and beats.</li>
