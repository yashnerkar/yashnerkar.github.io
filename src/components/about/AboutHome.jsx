...
const AboutHome = () => {
    return (
        <>  <div className="container-text container-fluid aboutdesc-div container  pt-4 ">
            <div className="d-flex  paracontent">
                <div className="mx-4 px-1 py-4 para">
                    <ol type="1">
                        <li>/**</li>
                        <li>&nbsp;* About me</li>
                ...
                <div className="aboutme-img px-3">
                    <img src="images/coffee.png" className=" img-fluid mt-2 ml-5" alt="" style={{ height: "28rem" }}></img>
                </div>
            </div>
        </div></>
    )
